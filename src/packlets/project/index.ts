...
export const projects: Project[] = [
  {
    url: `https://storage.rayriffy.com/files/labs/miraidayo-1.1.0.usdz#custom=https://labs.rayriffy.com/miraidayo/banner?1&customHeight=small&allowsContentScaling=0`,
    title: 'Mirai dayo~',
    description:
